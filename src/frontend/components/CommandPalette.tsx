...
import { useProjects, useSuites, useTestCases } from "@/frontend/store/store";
...
export function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = [
    ...
    },
    {
      ...
      section: "Navigate",
      icon: FlaskConical,
      action: () => go("/regression"),
      keywords: "smoke critical",
    },
    {
      id: "nav-reports",
      label: "Reports",
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-start justify-center pt-[15vh] bg-foreground/30 backdrop-blur-sm"
      onClick={onClose}
    >
      <div
