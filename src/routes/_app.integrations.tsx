...
const GitHubIcon = () => (
  <svg
    className="h-10 w-10 shrink-0 text-white dark:text-white light:text-neutral-900"
    viewBox="0 0 24 24"
    fill="currentColor"
  >
    <path
...
const SlackIcon = () => (
  <svg className="h-10 w-10 shrink-0" viewBox="0 0 24 24" fill="currentColor">
    ...
    />
    <path
      d="M8.835 5.042a2.528 2.528 0 0 1-2.52-2.52A2.528 2.528 0 0 1 8.835 0a2.528 2.528 0 0 1 2.52 2.522v2.52h-2.52zm0 1.261a2.528 2.528 0 0 1 2.52 2.52v5.043a2.528 2.528 0 0 1-2.52 2.522H3.792a2.528 2.528 0 0 1-2.522-2.522V8.823a2.528 2.528 0 0 1 2.522-2.52h5.043z"
      fill="#36C5F0"
    />
    <path
      d="M18.958 8.823a2.528 2.528 0 0 1 2.52-2.522 2.528 2.528 0 0 1 2.522 2.522 2.528 2.528 0 0 1-2.522 2.52h-2.52v-2.52zm-1.261 0a2.528 2.528 0 0 1-2.52 2.52h-5.043a2.528 2.528 0 0 1-2.522-2.52V3.792a2.528 2.528 0 0 1 2.522-2.52h5.043z"
      fill="#2EB67D"
    />
    <path
      d="M15.176 18.958a2.528 2.528 0 0 1 2.52 2.52 2.528 2.528 0 0 1-2.52 2.522 2.528 2.528 0 0 1-2.522-2.522v-2.52h2.522zm0-1.261a2.528 2.528 0 0 1-2.522-2.52v-5.043a2.528 2.528 0 0 1 2.522-2.52h5.043z"
      fill="#ECB22E"
    />
  </svg>
);
...
const TestRailIcon = () => (
  <svg className="h-10 w-10 shrink-0 text-[#2496DF]" viewBox="0 0 24 24" fill="currentColor">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 14h-2V9h2v7zm0-9h-2V5h2v2z"
    />
  </svg>
);
...
const INTEGRATIONS: IntegrationItem[] = [
  {
    key: "jira",
    name: "Jira",
    desc: "Sync failed test cases directly into Jira tickets to bridge QA and development pipelines.",
    category: "Project Management",
    icon: JiraIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(38,132,255,0.15)]",
    borderHoverClass: "hover:border-[#2684FF]",
    accentColor: "#2684FF",
  },
  {
    key: "github",
    name: "GitHub Actions",
    desc: "Link test runs to pull requests and trigger automatic repository status checks.",
    category: "CI/CD & Code",
    icon: GitHubIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(255,255,255,0.12)]",
    borderHoverClass: "hover:border-white/30",
    accentColor: "#FFFFFF",
  },
  {
    key: "slack",
    name: "Slack",
    desc: "Pipe real-time test run results, alert notifications, and bug filings into team Slack channels.",
    category: "Communication",
    icon: SlackIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(224,30,90,0.15)]",
    borderHoverClass: "hover:border-[#E01E5A]",
    accentColor: "#E01E5A",
  },
  {
    key: "gitlab",
    name: "GitLab CI",
    desc: "Trigger automated test executions on push event merge requests and parse pipelines reports.",
    category: "CI/CD & Code",
    icon: GitLabIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(252,109,38,0.15)]",
  ...
  },
  {
    key: "bitbucket",
    name: "Bitbucket",
    desc: "Verify repository builds with automated testing checklists on pull requests.",
    category: "CI/CD & Code",
    icon: BitbucketIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(38,132,255,0.15)]",
    borderHoverClass: "hover:border-[#0052CC]",
    accentColor: "#0052CC",
  },
  {
    key: "azure",
    name: "Azure DevOps",
    desc: "Integrate QA suites directly with Azure pipelines and test plan boards.",
    category: "CI/CD & Code",
    icon: AzureDevOpsIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(0,120,212,0.15)]",
    borderHoverClass: "hover:border-[#0078D4]",
    accentColor: "#0078D4",
  },
  {
    key: "zephyr",
    name: "Zephyr Scale",
    desc: "Track and link test cases inside Jira with Zephyr Scale enterprise suites.",
    category: "Test Management",
    icon: ZephyrIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(0,163,224,0.15)]",
    borderHoverClass: "hover:border-[#00A3E0]",
    accentColor: "#00A3E0",
  },
  {
    key: "testrail",
    name: "TestRail",
    desc: "Synchronize test runs, status logs, and QA metrics with TestRail dashboards.",
    category: "Test Management",
    icon: TestRailIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(36,150,223,0.15)]",
    borderHoverClass: "hover:border-[#2496DF]",
    accentColor: "#2496DF",
  },
  {
    key: "playwright",
    name: "Playwright",
    desc: "Sync end-to-end browser test definitions and execute runs in the cloud.",
    category: "Automation Frameworks",
    icon: PlaywrightIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(46,184,114,0.15)]",
    borderHoverClass: "hover:border-[#2EB872]",
    accentColor: "#2EB872",
  },
  {
    key: "cypress",
    name: "Cypress",
    desc: "Upload and analyze Cypress Test Runner execution recordings and test matrices.",
    category: "Automation Frameworks",
    icon: CypressIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(18,175,119,0.15)]",
    borderHoverClass: "hover:border-[#12AF77]",
    accentColor: "#12AF77",
  },
  {
    key: "jenkins",
    name: "Jenkins",
    desc: "Hook test generation pipelines into classical Jenkins freestyle builds.",
    category: "CI/CD & Code",
    icon: JenkinsIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(210,80,60,0.15)]",
    borderHoverClass: "hover:border-[#D2503C]",
    accentColor: "#D2503C",
  },
  {
    key: "jenkinsci",
    name: "Jenkins CI",
    desc: "Integrate declarative pipeline scripts for continuous QA regression verification.",
    category: "CI/CD & Code",
    icon: JenkinsCiIcon,
    glowClass: "hover:shadow-[0_0_30px_rgba(210,80,60,0.2)]",
    borderHoverClass: "hover:border-[#D2503C]",
    accentColor: "#D2503C",
  },
];
...
function IntegrationsPage() {
  ...
  const toggleConnection = (key: string, name: string) => {
    ...
    if (!deductTokenAction(newState ? `Connect ${name}` : `Disconnect ${name}`)) return;
  ...
  const filtered =
    filterCat === "all" ? INTEGRATIONS : INTEGRATIONS.filter((i) => i.category === filterCat);
              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`text-[10px] font-mono uppercase tracking-wider ${isOn ? "text-[var(--c-pass)] font-semibold" : "text-[var(--c-text-muted)]"}`}
                    >
                      {isOn ? "Online" : "Offline"}
                    </span>
                    <button
                ...
                <div className="mt-5 space-y-2">
                  <div className="flex items-center gap-1.5">
                    <h3 className="font-display text-xl leading-tight text-[var(--c-text)]">
                      {i.name}
                    </h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-[var(--c-border)]/40 bg-[var(--c-bg-card)]/50 p-4 flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-[var(--c-text-muted)]">
            Enable webhook streaming and background updates.
          </p>
        </div>
        <button
      ...
      <div className="flex gap-2 pt-2">
        <button
          onClick={() => {
            if (!deductTokenAction("Save integration settings")) return;
